...
@blueprint.route('/devices', methods=["POST", "GET"])
def devices():
    sort_type = "all"
    ...
    return render_template("main/devices.html", **context)


@blueprint.route('/adddevice', methods=['POST', 'GET'])
def add_device():
    ...
    return render_template("main/add_device.html", **context)


@blueprint.route('/removedevice', methods=['POST', 'GET'])
def remove_device():
    device_type = "LightBulb"
    if request.method == "POST":
    ...
    return render_template("main/remove_device.html", **context)
...
def log():
    ...
    return render_template("main/log.html", **context)
